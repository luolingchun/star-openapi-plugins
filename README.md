# star-openapi-plugins

Provide OpenAPI UI for [`star-openapi`](https://github.com/luolingchun/star-openapi):
...
> about [UI_Templates](https://luolingchun.github.io/star-openapi/latest/Usage/UI_Templates/).
